...
<body>
  ...
  <!-- SOLUÇÃO DEFINITIVA: Script inline simplificado -->
  <script>
    // Garantir que o cardápio apareça imediatamente
    (function() {
      // Número do WhatsApp
      ...
      const produtosBase = [
        ...
        { id: 'acai-500-1', nome: 'Batidinha de Açaí 500ml', descricao: '1 unidade (500ml)', preco: 22.00, img: 'https://i.pinimg.com/736x/cf/3e/ce/cf3eced59
