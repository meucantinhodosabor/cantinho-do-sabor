...
<body>
  ...
  <script>
    // CORREÇÃO 1: DOMContentLoaded para garantir que o HTML carregou
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Cardápio completo com todos os itens - CORREÇÃO dos valores de minRech e maxRech
      const produtosBase = [
        // Combos existentes
        ...
        // 🛠 Monte Pastel - CORRIGIDO: minRech = 1 para todos
        ...
        // 🌽 Monte Cuscuz - CORRIGIDO: minRech = 1 para todos
        ...
        // 🫔 Monte Tapioca - CORRIGIDO: minRech = 1 para todos
      ...
      function renderCardapio() {
              ...
              <div class="product-grid">
                ${prodCat.map(p => `
                  <div class="product-card" data-id="${p.id}">
                    <!-- CORREÇÃO 2: onerror para placeholder -->
        ...
        // CORREÇÃO 3: console.log para verificar quantidade
      ...
      function abrirModalProduto(prod) {
        ...
        if (prod.tipo === 'dueto') {
          ...
          html += `<div class="recheio-group"><h4>Selecione os recheios (mínimo ${prod.minRech} • máximo ${prod.maxRech})</h4>`;
          recheiosDisponiveis.forEach(r => {
            html += `<label class="recheio-option"><input type="checkbox" class="recheio-check" value="${r}"> ${r}</label>`;
          });
          html += `<div id="recheio-validation" class="validation-message">Selecione entre ${prod.minRech} e ${prod.maxRech} recheios</div>`;
          html += `</div>`;
        }
      ...
      function adicionarAoCarrinho(prod) {
        ...
        if (prod.tipo === 'dueto') {
          ...
          // CORREÇÃO: Validação correta dos recheios
      ...
      window.processarCheckout = () => {
        ...
        if (pagamento === 'pix') {
          ...
          // CORREÇÃO: Chamar diretamente sem precisar de múltiplos cliques
